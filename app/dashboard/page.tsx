    ...
    <div className="min-h-screen bg-[#020202] text-white overflow-hidden">
      ...
      <nav className="h-16  border-b border-white/5 flex items-center justify-between px-10 bg-obsidian">
        ...
        <div className="relative group z-50">
           ...
           {/* Dropdown Menu */}
           <div className="absolute right-0 top-full mt-2 w-48 rounded-lg border  bg-obsidian-light shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right">
