...
export default function DemoSection() {
  ...
  // We remove the containerRef since we don't need scroll triggers anymore
  ...
  // SIMPLIFIED ANIMATION: No ScrollTrigger, just a simple entrance on load.
  useGSAP(() => {
    if (!demoRef.current) return;
    
    // Simple Fade In + Slide Up (Like Hero)
